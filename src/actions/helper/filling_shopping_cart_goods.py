...
def filling_shopping_cart_goods(page: Page):
    ...
    path_first_button = "(//li[contains(@class, 'slick-active')])[1]//a[contains(text(), 'В корзину')]"
    path_second_pizza = "(//li[contains(@class, 'slick-active')])[4]"
    path_second_button = "(//li[contains(@class, 'slick-active')])[4]//a[contains(text(), 'В корзину')]"
