...
class TestPositiveValidationFieldPhone:
    ...
    @allure.title(
        'Позитивная проверка поля "Телефон". Номер с разделителями (+7 900 500-08-00)'
    )
    def test_valid_phone_separator(
        self, go_to_url, page: Page, error_field_telephone, error_field_username
    ):
        path_field_username = "//input[@name='username']"
        path_field_telephone = "//input[@name='billing_phone']"
    ...
    def test_valid_phone_international(
        self, go_to_url, page: Page, error_field_telephone, error_field_username
    ):
        path_field_username = "//input[@name='username']"
        path_field_telephone = "//input[@name='billing_phone']"
